...
class FRCNN(object):
    ...
    def detect_image(self, image):
        ...
        name = {'corpulenta':	'草履蚧',
                ...
                'montelus':	'丝带凤蝶',
                'flavescensRuo':	'黄刺峨幼虫',
                'anachoretaRuo':	'杨扇舟蛾幼虫',
                'anachoretaEgg':	'杨扇舟蛾卵',
                'cuneaRuo':	'美国白鹅幼虫',
                'montelusRuo':	'丝带凤蝶幼虫',
                'corpulentaRuo':	'草履蚧幼虫',
                'corpulentaMale':	'草履蚧雄虫',
                'fulloRuo':	'麻皮蝽若虫',
                'versicoloraRuo':	'柳蓝叶甲幼虫',
                'troglodytaYong':	'杨小舟蛾蛹',
                'subcarneaRuo':	'人纹污灯蛾'}
        ...
        f = open("C:\\Users\\张浩天\\Desktop\\PestsIdentification\\web\\WEB-INF\\saved\\file.txt","w")
        f.write("")
        f = open("C:\\Users\\张浩天\\Desktop\\PestsIdentification\\web\\WEB-INF\\saved\\file.txt","a")    
