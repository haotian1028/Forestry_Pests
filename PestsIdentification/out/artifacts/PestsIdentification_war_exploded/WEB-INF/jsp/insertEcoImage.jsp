...
<div class="layui-fluid">
    <div class="layui-row">
        ...
        <h1>
            <small class="layui-font-cyan">添加生态图片</small>
        </h1>
    </div>
    </div>
    <div class="layui-row">
    ...
    <div class="layui-row">
        <div class="layui-col-xs12">
            <div class="layui-card">
                <form action="${pageContext.request.contextPath}/image/insertImage?id=${id}&method=2" enctype="multipart/form-data" method="post">
