...
<div class="layui-fluid">
    <div class="layui-row">
            <ul class="layui-nav" lay-filter="test" >
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child"> <!-- 二级菜单 -->
                        <dd class="layui-this"><a href="${pageContext.request.contextPath}/allOrder">科信息</a></dd>
        ...
        <div class="layui-col-xs12" style="float: left">
            <h1>
                <small class="layui-font-cyan">科列表</small>
            </h1>
        </div>
    </div>
    <div class="layui-row">
    ...
    <div class="layui-row">
        <div class="layui-col-xs12">
            <table class="table" lay-filter="demo">
                <thead>
                <tr>
                    <th lay-data="{field:'username1', width:390}">科代码</th>
                    <th lay-data="{field:'username2', width:390}">科名称</th>
                ...
                <c:forEach var="order" items="${list}">
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/familyList?id=${order.orderId}">查询包含目信息</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
