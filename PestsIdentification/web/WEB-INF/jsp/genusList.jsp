            ...
            <ul class="layui-nav" lay-filter="test">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child"> <!-- 二级菜单 -->
                        ...
                        <dd class="layui-this"><a href="#">属信息</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item"><a href="${pageContext.request.contextPath}/image/toPredict">害虫识别</a></li>
                <li class="layui-nav-item"><a href="${pageContext.request.contextPath}/allFamily">返回</a></li>
            </ul>
        <div class="layui-col-xs12" style="float: left">
            <h1>
                <small class="layui-font-cyan">属列表</small>
            </h1>
        </div>
    </div>
    <div class="layui-row">
    ...
    <div class="layui-row">
        <div class="layui-col-xs12">
            <table class="table" lay-filter="demo">
                <thead>
                <tr>
                    <th lay-data="{field:'username1', width:390}">属代码</th>
                    <th lay-data="{field:'username2', width:390}">属名称</th>
                    <th lay-data="{field:'username4', width:350}"></th>
                </tr>
                </thead>
                <tbody>
                <c:forEach var="genus" items="${list}">
                    <tr>
                        <td>${genus.genusId}</td>
                        <td>${genus.genusName}</td>
                        <td>
                            <a href="${pageContext.request.contextPath}/insectByGenus?id=${genus.genusId}&name=${genus.genusName}">查询包含昆虫信息</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
