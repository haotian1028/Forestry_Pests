...
<div class="layui-fluid">
    <div class="layui-row">
            <ul class="layui-nav" lay-filter="test">
                ...
                <li class="layui-nav-item layui-this"><a href="${pageContext.request.contextPath}/allPest">查询害虫</a></li>
    ...
    <div class="layui-col-xs12" style="float: left">
        <h1>
            <small class="layui-font-cyan">害虫列表</small>
        </h1>
    </div>
    <div class="layui-row">
        ...
        <div class="layui-col-xs12">
            <table class="table" lay-filter="demo">
                ...
                <tr>
                    ...
                    <th lay-data="{field:'username2', width:300}">害虫代码</th>
                    <th lay-data="{field:'username3', width:400}">拉丁学名</th>
                    <th lay-data="{field:'username4', width:150}"></th>
                </tr>
                </thead>
                <tbody>
