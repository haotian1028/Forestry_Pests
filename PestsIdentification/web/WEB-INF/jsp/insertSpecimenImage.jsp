...
<div class="layui-fluid">
    <div class="layui-row">
            <ul class="layui-nav" lay-filter="test" >
                ...
                <li class="layui-nav-item"><a href="${pageContext.request.contextPath}/allInsect">所有昆虫</a></li>
                ...
                <li class="layui-nav-item  layui-this"><a href="#">添加生态图片</a></li>
            </ul>
        <div class="layui-col-xs12" style="float: left">
            <h1>
                <small class="layui-font-cyan">添加标本图片</small>
            </h1>
        </div>
    </div>
    <div class="layui-row">
    ...
    <div class="layui-row">
        <div class="layui-col-xs12">
            <div class="layui-card">
                <form action="${pageContext.request.contextPath}/image/insertImage?id=${id}&method=1" enctype="multipart/form-data" method="post">
                    <div class="layui-card-header"><input type="file" name="file"/></div>
