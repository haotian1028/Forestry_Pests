...
<div class="layui-fluid">
    <div class="layui-row">
            <ul class="layui-nav" lay-filter="test">
                ...
                <li class="layui-nav-item layui-this"><a href="#">害虫识别</a></li>
            </ul>
        <div class="layui-col-xs12" style="float: left">
            <h1>
                <small class="layui-font-cyan">害虫识别</small>
            </h1>
        </div>
    </div>
    <div class="layui-row">
    ...
    <div class="layui-row">
        <div class="layui-col-xs12">
            <div class="layui-card">
                <form action="${pageContext.request.contextPath}/image/predict" enctype="multipart/form-data" method="post">
